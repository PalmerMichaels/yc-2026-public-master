...
- Slug: `talking-computers`
- Batch: Winter 2026
- Status: Active
- Classification: `copyable`
- Implementation Status: `classified`
- Source: https://www.ycombinator.com/companies/talking-computers
...
- Repository: `talking-computers-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai for ai infrastructure: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
