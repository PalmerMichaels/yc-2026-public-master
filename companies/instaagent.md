...
- Source: https://www.ycombinator.com/companies/instaagent
- Website: https://instaagent.com
- GitHub Project: https://github.com/users/PalmerMichaels/projects/2
- GitHub Issue: https://github.com/PalmerMichaels/yc-2026-public-master/issues/84
- Implementation Repository: https://github.com/PalmerMichaels/instaagent-public
- Implementation Commit: `20b589dffde7f9c83f2aed2c3fd8cc26bb33e043`

## Public Description

Scale marketing campaigns across hundreds of personas

InstaAgent helps consumer brands scale a single campaign across hundreds of specific audiences on Meta and TikTok, each with its own content, voice, and targeting. Traction: $1M ARR in 10 months. From one brief, we create personalized creatives, distribute them through paid channels and niche social accounts, and use performance data to learn what works, scale winners, and improve every campaign.
...
- Status: `implemented`
- Repository: https://github.com/PalmerMichaels/instaagent-public
- Commit: `20b589dffde7f9c83f2aed2c3fd8cc26bb33e043`
- Notes: Implemented and pushed; local main matches origin/main.

## Proposed Public Repository

- Repository: `instaagent-public`

## End-to-End Implementation Scope

Build an original web app demonstrating scale marketing campaigns across hundreds of personas: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
