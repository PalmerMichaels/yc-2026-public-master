...
- Source: https://www.ycombinator.com/companies/rhizome-ai
...
- Repository: `rhizome-ai-public`

## End-to-End Implementation Scope

Build an original web app demonstrating agent platform for life sciences: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
