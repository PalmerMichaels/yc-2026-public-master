...
Ara is the self-driving IDE for software teams.

Ara is the self-driving IDE for software teams. It watches work in progress, suggests the next step, and executes tasks through non-invasive computer use, background agents, memory, and reusable skills. Ara turns coding into a closed loop: suggest, act, learn, improve.
...
- Repository: `ara-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ara is the self-driving ide for software teams.: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
