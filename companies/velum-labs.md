...
- Source: https://www.ycombinator.com/companies/velum-labs
...
- Repository: `velum-labs-public`

## End-to-End Implementation Scope

Build an original web app that demonstrates the os for data quality across any stack: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
