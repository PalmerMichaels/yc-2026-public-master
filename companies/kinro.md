...
- Source: https://www.ycombinator.com/companies/kinro
- Website: https://www.kinro.com/
- GitHub Project: https://github.com/users/PalmerMichaels/projects/2
- GitHub Issue: https://github.com/PalmerMichaels/yc-2026-public-master/issues/95
- Implementation Repository: https://github.com/PalmerMichaels/kinro-public
- Implementation Commit: `f7ccc8ebbcdfc6c2a24fc223514322f78de6d231`
...
- Status: `implemented`
- Repository: https://github.com/PalmerMichaels/kinro-public
- Commit: `f7ccc8ebbcdfc6c2a24fc223514322f78de6d231`
- Notes: Implemented and pushed; local main matches origin/main.

## Proposed Public Repository

- Repository: `kinro-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai sales agents for insurance. sell everywhere your buyers are.: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
