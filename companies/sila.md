...
- Source: https://www.ycombinator.com/companies/sila
...
Sila is an agentic work messaging & collaboration platform where teams and AI work as one. Our mission is to define the standard for how companies will work.
...
- Repository: `sila-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai work messaging & collaboration platform: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
