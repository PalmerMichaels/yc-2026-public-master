...
- Source: https://www.ycombinator.com/companies/captain
...
- Repository: `captain-public`

## End-to-End Implementation Scope

Build an original web app demonstrating give ai agents accurate knowledge search that scales: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
