...
- Source: https://www.ycombinator.com/companies/doomersion
...
- Repository: `doomersion-public`

## End-to-End Implementation Scope

Build an original web app that demonstrates doomscroll to learn languages: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
