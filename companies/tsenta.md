...
- Source: https://www.ycombinator.com/companies/tsenta
...
We match you with jobs and apply automatically
...
- Repository: `tsenta-public`

## End-to-End Implementation Scope

Build an original web app demonstrating we match you with jobs and apply automatically: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
