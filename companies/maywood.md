...
- Source: https://www.ycombinator.com/companies/maywood
...
- Repository: `maywood-public`

## End-to-End Implementation Scope

Build an original web app demonstrating the first finance-compliant proactive ai that runs 24/7: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
