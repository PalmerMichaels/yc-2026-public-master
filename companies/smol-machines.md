...
Build an original web app that demonstrates ship software faster with portable, self contained virtual machines: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
