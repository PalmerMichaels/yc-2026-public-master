...
- Source: https://www.ycombinator.com/companies/smol-machines
...
- Repository: `smol-machines-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ship software faster with portable, self contained virtual machines.: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
