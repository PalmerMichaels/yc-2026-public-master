...
- Source: https://www.ycombinator.com/companies/end-close
...
- Repository: `end-close-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai powered reconciliation for high-volume payments companies: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
