...
Build an original web app that demonstrates the ai-native consulting firm for ai transformation: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
