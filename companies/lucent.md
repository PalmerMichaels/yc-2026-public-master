...
- Source: https://www.ycombinator.com/companies/lucent
...
AI that automatically improves products from user behavior

Lucent is an AI product manager that automatically improves products based on how users behave. We use AI to watch and understand user sessions and detect bugs and UX issues.
...
- Repository: `lucent-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai that automatically improves products from user behavior: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
