...
- Source: https://www.ycombinator.com/companies/incandor
- Website: https://www.incandor.com
- GitHub Project: https://github.com/users/PalmerMichaels/projects/2
- GitHub Issue: https://github.com/PalmerMichaels/yc-2026-public-master/issues/80
- Implementation Repository: https://github.com/PalmerMichaels/incandor-public
- Implementation Commit: `3399b044335b586ad861e57ea7eb836631cd88e4`
...
- Status: `implemented`
- Repository: https://github.com/PalmerMichaels/incandor-public
- Commit: `3399b044335b586ad861e57ea7eb836631cd88e4`
- Notes: Implemented and pushed; local main matches origin/main.

## Proposed Public Repository

- Repository: `incandor-public`

## End-to-End Implementation Scope

Build an original web app demonstrating behavioral intelligence infrastructure for anti-fraud: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
