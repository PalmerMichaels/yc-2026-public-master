...
- Source: https://www.ycombinator.com/companies/tryprism
...
AI-native recruiting agency

Prism is an AI-native recruiting agency. We use software and agents to find companies better people faster.
...
- Repository: `tryprism-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai-native recruiting agency: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
