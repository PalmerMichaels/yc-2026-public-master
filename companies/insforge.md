...
- Source: https://www.ycombinator.com/companies/insforge
- Website: https://insforge.dev/
- GitHub Project: https://github.com/users/PalmerMichaels/projects/2
- GitHub Issue: https://github.com/PalmerMichaels/yc-2026-public-master/issues/83
...
- Repository: `insforge-public`

## End-to-End Implementation Scope

Build an original web app that demonstrates the agent-native cloud infrastructure platform: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
