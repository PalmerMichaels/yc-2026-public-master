...
- Source: https://www.ycombinator.com/companies/claimglide
...
- Repository: `claimglide-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai automated prior-auths for private medical practices: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
