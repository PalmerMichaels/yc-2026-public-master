...
- Source: https://www.ycombinator.com/companies/soria
- Website: https://www.soriaanalytics.com/
...
- Repository: `soria-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai bloomberg terminal built for healthcare (and beyond): onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
