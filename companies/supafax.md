...
- Source: https://www.ycombinator.com/companies/supafax
...
AI assistant for your email and calendar
...
- Repository: `supafax-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai assistant for your email and calendar: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
