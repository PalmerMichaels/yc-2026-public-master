...
- Source: https://www.ycombinator.com/companies/runanywhere
...
- Repository: `runanywhere-public`

## End-to-End Implementation Scope

Build an original web app that demonstrates the default way of running on-device ai at scale: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
