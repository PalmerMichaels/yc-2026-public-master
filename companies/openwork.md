...
- Source: https://www.ycombinator.com/companies/openwork
...
OpenWork is a desktop app that lets people connect to their existing skills, MCPs, and agents. Users can download the app for free, try it with over 50+ model providers, and easily share their setup with their team.
...
- Repository: `openwork-public`

## End-to-End Implementation Scope

Build an original web app demonstrating the open source alternative to claude cowork: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
