...
- Source: https://www.ycombinator.com/companies/patientdeskai
...
AI front & back office agent for dental practices

Patientdesk is an AI bookings system that helps healthcare practices make more money. We do this by handling bookings, payments, and insurance to fill up a provider's calendar with high value appointments.
...
- Repository: `patientdeskai-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai front & back office agent for dental practices: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
