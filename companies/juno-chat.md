...
- GitHub Issue: https://github.com/PalmerMichaels/yc-2026-public-master/issues/90
- Implementation Repository: https://github.com/PalmerMichaels/juno-chat-public

## Public Description

AI Health Assistant for Chronic Illness

Juno is an AI personal health assistant for the 1B+ people living with chronic illness. Launched in October, Juno now supports 90,000+ patients globally and has grown to $70K MRR.
...
- Status: `in-progress`
- Repository: https://github.com/PalmerMichaels/juno-chat-public
- Notes: Implementation repository pre-created and worker launched by meta; public implementation in progress.

## Proposed Public Repository

- Repository: `juno-chat-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai health assistant for chronic illness: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
