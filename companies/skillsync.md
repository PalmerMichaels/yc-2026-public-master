...
- Source: https://www.ycombinator.com/companies/skillsync
...
Hire engineers based on what they’ve shipped
...
- Repository: `skillsync-public`

## End-to-End Implementation Scope

Build an original web app demonstrating hire engineers based on what they’ve shipped: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
