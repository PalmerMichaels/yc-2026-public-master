...
- Source: https://www.ycombinator.com/companies/wayco
...
AI operator for medlegal cases
...
- Repository: `wayco-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai operator for medlegal cases: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
