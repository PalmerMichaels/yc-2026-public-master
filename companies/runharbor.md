...
- Source: https://www.ycombinator.com/companies/runharbor
...
- Repository: `runharbor-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai-native cro for clinical trial operations: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
