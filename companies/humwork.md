...
- Source: https://www.ycombinator.com/companies/humwork
- Website: https://humwork.ai
- GitHub Project: https://github.com/users/PalmerMichaels/projects/2
- GitHub Issue: https://github.com/PalmerMichaels/yc-2026-public-master/issues/76
- Implementation Repository: https://github.com/PalmerMichaels/humwork-public
- Implementation Commit: `b033fdbcea7744d17a1aa28387365b89d1d93014`
...
- Status: `implemented`
- Repository: https://github.com/PalmerMichaels/humwork-public
- Commit: `b033fdbcea7744d17a1aa28387365b89d1d93014`
- Notes: Implemented and pushed; local main matches origin/main.

## Proposed Public Repository

- Repository: `humwork-public`

## End-to-End Implementation Scope

Build an original web app demonstrating connect ai agents to human experts in 30 seconds: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
