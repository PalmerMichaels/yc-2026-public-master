...
Bubble Lab turns natural language into visual, production-ready workflows — built for modern ops teams, with built-in observability, logs, and execution traces. Deploy to Slack in one click so your team can build and run workflows from anywhere.
...
- Repository: `bubble-lab-public`

## End-to-End Implementation Scope

Build an original web app demonstrating prompt once, automate forever.: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
