...
- Source: https://www.ycombinator.com/companies/corvera
...
- Repository: `corvera-public`

## End-to-End Implementation Scope

Build an original web app demonstrating the context layer for ai-native cpg brands: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
