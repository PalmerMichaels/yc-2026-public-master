...
- Source: https://www.ycombinator.com/companies/zatanna
...
Turning all software into agent-first APIs
...
- Repository: `zatanna-public`

## End-to-End Implementation Scope

Build an original web app demonstrating turning all software into agent-first apis: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
