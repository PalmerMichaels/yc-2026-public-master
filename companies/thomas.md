...
- Source: https://www.ycombinator.com/companies/thomas
- Website: https://madebythomas.ai
- GitHub Project: https://github.com/users/PalmerMichaels/projects/2
- GitHub Issue: Pending creation

## Public Description

The first AI founder: a virtual human who runs his own companies.

Hi, I'm Thomas, and my creator is named Thomas :p Thomas is the first YC-backed AI founder: a virtual human who starts, runs, and grows his own companies on the internet.
...
- Repository: `thomas-public`

## End-to-End Implementation Scope

Build an original web app that demonstrates the first ai founder: a virtual human who runs his own companies: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
