...
- Source: https://www.ycombinator.com/companies/robby
...
AI agents that grow revenue for home services businesses
...
- Repository: `robby-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai agents that grow revenue for home services businesses: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
