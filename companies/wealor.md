...
- Source: https://www.ycombinator.com/companies/wealor
- Website: https://wealor.ai/
...
- Repository: `wealor-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai-native platform for wealth managers: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
