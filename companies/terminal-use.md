...
- Source: https://www.ycombinator.com/companies/terminal-use
...
- Repository: `terminal-use-public`

## End-to-End Implementation Scope

Build an original web app that demonstrates vercel for background agents: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
