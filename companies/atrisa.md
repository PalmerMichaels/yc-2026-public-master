...
- Source: https://www.ycombinator.com/companies/atrisa
- Website: https://atrisa.ai
- GitHub Project: https://github.com/users/PalmerMichaels/projects/2
- GitHub Issue: https://github.com/PalmerMichaels/yc-2026-public-master/issues/32
- Implementation Repository: https://github.com/PalmerMichaels/atrisa-public

## Public Description

AI Agents for Analog Circuit Design

AI Agents to build, debug and automate analog circuit design
...
- Status: `in-progress`
- Repository: https://github.com/PalmerMichaels/atrisa-public
- Notes: Implementation repository pre-created and worker launched by meta; public implementation in progress.

## Proposed Public Repository

- Repository: `atrisa-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai agents for analog circuit design: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
