...
- Source: https://www.ycombinator.com/companies/oximy
...
- Repository: `oximy-public`

## End-to-End Implementation Scope

Build an original web app demonstrating see and control all ai activity across your enterprise: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
