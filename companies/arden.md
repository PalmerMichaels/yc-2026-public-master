...
- Source: https://www.ycombinator.com/companies/arden
- Website: https://ardentech.ai/
- GitHub Project: https://github.com/users/PalmerMichaels/projects/2
- GitHub Issue: https://github.com/PalmerMichaels/yc-2026-public-master/issues/22
- Implementation Repository: https://github.com/PalmerMichaels/arden-public
...
- Status: `in-progress`
- Repository: https://github.com/PalmerMichaels/arden-public
- Notes: Implementation repository/workers launched by meta; public implementation in progress.

## Proposed Public Repository

- Repository: `arden-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai agents that automate sox control testing.: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
