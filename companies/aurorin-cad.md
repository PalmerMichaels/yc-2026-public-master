...
- Source: https://www.ycombinator.com/companies/aurorin-cad
...
- Repository: `aurorin-cad-public`

## End-to-End Implementation Scope

Build an original web app that demonstrates claude code for mechanical engineers: onboarding, workspace/project setup, core workflow screens, sample data, role-aware task/status management, and mocked external integrations where needed. Include seed data, tests, and clear clean-room documentation.
