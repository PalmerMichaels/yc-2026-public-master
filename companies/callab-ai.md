...
- Repository: `callab-ai-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai voice agents for on-prem telephony stack.: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
