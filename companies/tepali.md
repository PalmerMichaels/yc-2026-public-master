...
- Source: https://www.ycombinator.com/companies/tepali
...
AI-native operating system for aesthetics & wellness

Tepali is the AI-native operating system for medspas. We replace fragmented software and manual work with a single system of record powered by AI agents that handle front desk, patient documentation, and lead conversion.
...
- Repository: `tepali-public`

## End-to-End Implementation Scope

Build an original web app demonstrating ai-native operating system for aesthetics & wellness: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
