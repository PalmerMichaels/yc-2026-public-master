...
Superset helps engineers run 100s of coding agents in parallel.
...
- Repository: `superset-public`

## End-to-End Implementation Scope

Build an original web app demonstrating the ide for the ai agents era: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
