...
- Source: https://www.ycombinator.com/companies/rentahuman
...
- Repository: `rentahuman-public`

## End-to-End Implementation Scope

Build an original web app demonstrating marketplace for ai agents to hire humans.: onboarding, workspace/project setup, core workflow screens, sample/synthetic data, role-aware task/status management, mock external integrations where needed, and clear clean-room/non-regulated disclaimers. Include seed data, tests, and documentation.
